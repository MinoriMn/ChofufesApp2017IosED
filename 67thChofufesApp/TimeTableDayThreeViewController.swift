//
//  TimeTableDayThreeViewController.swift
//  67thChofufesApp
//
//  Created by 松田尚也 on 2017/09/23.
...
class TimeTableDayThreeViewController: UIViewController, IndicatorInfoProvider {
    
    var itemInfo: IndicatorInfo = "3日目"
    let Day : String = "d3"
